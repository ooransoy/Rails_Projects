...
class StampsControllerTest < ActionController::TestCase
  ...
  test "should create stamp" do
    assert_difference('Stamp.count') do
      post :create, stamp: { date_and_time: @stamp.date_and_time, event: @stamp.event, profile_id: @stamp.profile_id, subject: @stamp.subject }
    end
  ...
  test "should update stamp" do
    patch :update, id: @stamp, stamp: { date_and_time: @stamp.date_and_time, event: @stamp.event, profile_id: @stamp.profile_id, subject: @stamp.subject }
    assert_redirected_to stamp_path(assigns(:stamp))
  end
